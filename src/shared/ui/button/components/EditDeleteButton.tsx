...
import type { EditDeleteButtonType } from '@shared/ui/button/types/button.type';
import { Popover, PopoverContent, PopoverTrigger } from '@shared/ui/shadcn/components/popover';
import { MoreVerticalIcon, Trash2Icon } from 'lucide-react';

export default function EditDeleteButton({ onDelete }: EditDeleteButtonType) {
	return (
		<Popover>
			<PopoverTrigger>
			...
			<PopoverContent className="flex w-fit flex-col justify-center items-center text-sm p-0">
				...
				<PopoverClose asChild>
					<button type="button" className="flex justify-center items-center gap-x-1 p-3" onClick={onDelete}>
