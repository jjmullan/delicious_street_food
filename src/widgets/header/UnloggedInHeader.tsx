...
function UnloggedInHeader() {
	...
	return (
		<header className="flex justify-between items-center px-4 h-12 text-lg w-full max-w-[768px] min-w-[360px] md:border-x mx-auto">
			...
			<h2 className="text-center">{currentHref === 'login' ? '' : currentHref === 'email' ? '로그인' : '회원가입'}</h2>
