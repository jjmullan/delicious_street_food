		...
		<AlertDialog open={store.isOpen}>
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription className="flex flex-col gap-y-2 items-center">
						<img src={author} alt="author" width={64} />
						<div className="text-muted-foreground flex justify-center items-center gap-x-1">
				...
				<AlertDialogFooter>
					...
					<AlertDialogAction onClick={handleActionClick}>지도에 지금 바로 추가하기</AlertDialogAction>
				</AlertDialogFooter>
			</AlertDialogContent>
		</AlertDialog>
	);
